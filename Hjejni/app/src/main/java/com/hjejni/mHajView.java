 ...
 */
public class mHajView extends ActionBarActivity {
    ...
    private static final String url_update_product = "http://52.89.129.22/android_login_api/api/update_haj.php";
    // single product url
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_mhaj);
    ...
    class SaveDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(mHajView.this);
