...
public class HajBtn extends ActionBarActivity {
    ...
    private static String url_create_haj = "http://52.89.129.22/android_login_api/api/create_haj.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.btn_haj);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(HajBtn.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }


    class CreateNewHaj extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HajBtn.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_create_haj,
                    "POST", params);
