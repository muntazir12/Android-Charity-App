...
public class MessageView extends ActionBarActivity {
    ...
    private static final String url_delete_message = "http://52.89.129.22/android_login_api/api/delete_rmessage.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.message_det);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(MessageView.this, LoginActivity.class);
    ...
    class GetMessageDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MessageView.this);
                        ...
                        if (success == 1) {
...

                            {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent i = new Intent(MessageView.this, MessageBtn.class);
...

                            {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (table.equals("Haj")) {
                                        Intent i = new Intent(MessageView.this, mHajView.class);
                                        i.putExtra("pid", pid);
                                        startActivity(i);
                                    } else if (table.equals("Umrah")) {
                                        Intent i = new Intent(MessageView.this, mUmrahView.class);
                                        i.putExtra("pid", pid);
                                        startActivity(i);
                                    }
